...
namespace WinFormsApp
{
    public class Utility
    {
        ...
        public void labelMessageSuccess(Label chosenLabel,string labelInput)
        {
            chosenLabel.Text = (labelInput);
        ...
        public void labelMessageFailure(Label chosenLabel, string labelInput)
        {
            chosenLabel.Text = (labelInput);
